...
First-time testers can follow the [Testing Guide](./docs/TESTING.md). Release details are in [ReadyType 1.3.0](./docs/versions/1.3.0/README.md), and upcoming work is tracked in the [Roadmap](./docs/ROADMAP.md).
...
- Public source builds do not send anonymous analytics by default. When enabled in an official build, analytics include anonymous feature events plus app, system, and device compatibility metadata, but never audio, text content, window titles, common words, clipboard data, or DeepSeek keys.
