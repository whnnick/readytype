...
First-time testers can follow the [Testing Guide](./docs/TESTING.md). Upcoming work is tracked in the [Roadmap](./docs/ROADMAP.md) and [ReadyType 1.2.0 UI/UX Refresh](./docs/versions/1.2.0/README.md).
