...
First-time testers can follow the [Testing Guide](./docs/TESTING.md). Release details are in [ReadyType 1.5.1](./docs/versions/1.5.1/README.md), and upcoming work is tracked in the [Roadmap](./docs/ROADMAP.md).
