...
第一次试用可以参考 [测试说明](./docs/TESTING.zh-CN.md)，也可以直接使用 [测试邀请文案](./docs/TESTER_INVITE.zh-CN.md)。后续功能计划见 [Roadmap](./docs/ROADMAP.zh-CN.md) 和 [ReadyType 1.1.0 计划](./docs/versions/1.1.0/PLAN.zh-CN.md)。
