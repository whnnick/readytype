...
第一次试用可以参考 [测试说明](./docs/TESTING.zh-CN.md)，也可以直接使用 [测试邀请文案](./docs/TESTER_INVITE.zh-CN.md)。本次发布详情见 [ReadyType 1.3.0](./docs/versions/1.3.0/README.zh-CN.md)，后续功能计划见 [Roadmap](./docs/ROADMAP.zh-CN.md)。
