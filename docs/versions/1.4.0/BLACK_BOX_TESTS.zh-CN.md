...
最后更新：2026-07-14。当前验收构建仍标识为 `1.2.0 (80)`，尚未进入 1.4.0 发布阶段。
...
| Dashboard 事件展示 | 部分完成 | Test Mode 已开启；免费套餐每天入库一次，当前 Recent Events 尚未展示首次事件。 |
...
1. 免费套餐完成下一次入库后，在 Test Mode 的 Recent Events 中确认 `app_launched`。
