# ReadyType 1.5.0 Implementation Plan

1. Reduce primary navigation to Home, Usage Overview, Common Words, and Settings.
2. Add Settings category switching while reusing existing feature views and state.
